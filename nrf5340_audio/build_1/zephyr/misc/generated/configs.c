...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ISO_MAX_CHAN, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ASCS_ASE_SNK_COUNT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ASCS_ASE_SRC_COUNT, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PACS_SNK_CONTEXT, 0x0005);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_AUDIO_BITRATE_UNICAST_SINK, 96000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ASCS_MAX_ACTIVE_ASES, 1);
